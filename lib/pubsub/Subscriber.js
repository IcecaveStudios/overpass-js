(function() {
  var EventEmitter, Subscriber, Topic, bluebird, regexEscape,
  ...
  module.exports = Subscriber = (function(_super) {
    ...
    Subscriber.prototype.subscribe = function(topic) {
      ...
      switch (topic.state) {
        ...
        case "unsubscribed":
          ...
          return topic.promise = this._subscribe(topic);
        case "unsubscribing":
          topic.state = "subscribing";
          return topic.promise = topic.promise.then((function(_this) {
            return function() {
    ...
    Subscriber.prototype.unsubscribe = function(topic) {
      ...
      switch (topic.state) {
        ...
        case "subscribed":
          ...
          return topic.promise = this._unsubscribe(topic);
        case "subscribing":
          topic.state = "unsubscribing";
          return topic.promise = topic.promise.then((function(_this) {
            return function() {
    ...
    Subscriber.prototype._subscribe = function(topic) {
      return this.driver.subscribe(topic.name).then((function(_this) {
        return function() {
          return topic.state = "subscribed";
        };
        ...
        return function(error) {
          _this.topic.state = "unsubscribed";
          throw error;
        };
      })(this));
    };
    ...
    Subscriber.prototype._unsubscribe = function(topic) {
      return this.driver.unsubscribe(topic.name).then((function(_this) {
        return function() {
          return topic.state = "unsubscribed";
        };
      })(this)).tap((function(_this) {
        return function() {
