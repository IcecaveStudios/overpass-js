...
(function() {
  ...
  module.exports = AmqpRpcClient = (function() {
    function AmqpRpcClient(channel, timeout1, declarationManager, serialization, logger) {
      this.channel = channel;
      this.timeout = timeout1 != null ? timeout1 : 10;
    ...
    AmqpRpcClient.prototype._recv = function(message) {
      var e, id, ref, response;
      id = (ref = message.properties.correlationId) != null ? ref : null;
      if (id == null) {
